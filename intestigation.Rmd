...
#convert Date to numeric for regression modeling
...
PR_quarterly <- na.omit(PR_quarterly) #make quarterly

ts_data <- ts(PR_quarterly$Total_pop, frequency = 4)  #number of quarters in a year
fit_arima <- auto.arima(ts_data)
forecast_result <- forecast(fit_arima, h = 12)  #forecasting the next 12 periods
