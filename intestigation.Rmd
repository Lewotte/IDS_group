...
ts_data <- ts(PR_quarterly$Total_pop, frequency = 4)  #number of quarters in a year
...
ts_vs_real %>%
  ...
  scale_color_manual(values = c("Point Forecast" = "blue", "Lo 95" = "green", "Hi 95" = "orange", "Total_pop" = "red")) +
