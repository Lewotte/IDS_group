...
custody_plot <- Custody_PD_sliced %>%
  ...
  geom_vline(xintercept = lockdown_start, linetype = "dotted", size = 0.5, alpha = 0.5) +
  geom_vline(xintercept = lockdown_end, linetype = "dotted", size = 0.5, alpha = 0.5) +
  # geom_vline(xintercept = ymd("2021-07-19"), linetype = "dotted", size = 0.5) +
  annotate(
    "rect",
    fill = "coral",
    xmin = lockdown_start, xmax = lockdown_end, 
    ymin = -Inf, ymax = Inf, alpha = 0.33
    ) +
...
export.width <- 1440 / 200
ggsave("img/Sky-ppt_noReaction.jpg", plot = custody_plot, width = export.width, height = export.width*9/16, units = "in")
