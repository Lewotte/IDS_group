...
**Model 1 (custody_fit_yesInt)** Adjusted R-squared for custody_fit_yesInt: 0.1662803 

**Model 2 (custody_fit_noInt)** Adjusted R-squared for custody_fit_noInt: 0.1699272 

**Model 3 (custody_fit_Simple)** Adjusted R-squared for custody_fit_Simple: 0.1734328 

##### Interpretion

According to Occam's Razor, the simplest model that still provides meaningful explanatory power should be choosed. The differences between the three models is not significant. Since the adjusted r-squared of Model 3 is the highest and its simplicity, this makes it the most interpretable for directly assessing the lockdown’s effect. 
